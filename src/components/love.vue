    ...
    <div class="bg-wrap my-animation-slide-top">
      ...
      <div class="love-wrap transformCenter">
        <div>
          <el-avatar
            class="love-avatar"
            :src="$common.getAvatarUrl(love.manCover)"
          >
        ...
        <div>
          <el-avatar
            class="love-avatar"
            :src="$common.getAvatarUrl(love.womanCover)"
          >
            <img :src="$getDefaultAvatar()" />
          </el-avatar>
          <div class="love-title">
    ...
    <div class="love-container">
      ...
      <div style="padding: 0 20px">
        ...
        <div class="card-container">
          <div
            id="treeHole"
            v-show="card === 1 && !$common.isEmpty(treeHoleList)"
          >
            <treeHole
          ...
          <div v-show="card === 2 && !$common.isEmpty(photoTitleList)">
            ...
            <div class="pagination-wrap">
              <div
                @click="pagePhotos()"
                class="pagination"
                v-if="photoList.length < photoPagination.total"
              >
                下一页
              </div>
        ...
        <div v-show="card === 4">
            ...
            >
              ...
              >
                <div>
                  <el-avatar
                    class="family-avatar"
                    :src="$common.getAvatarUrl(item.manCover)"
                  >
                    <img :src="$getDefaultAvatar()" />
                  </el-avatar>
                ...
                <div>
                  <el-avatar
                    class="family-avatar"
                    :src="$common.getAvatarUrl(item.womanCover)"
                  >
                    <img :src="$getDefaultAvatar()" />
                  </el-avatar>
                  <div class="family-title">
          ...
          <div class="family-bottom-wrap">
            <div
              v-show="
                !$common.isEmpty(randomFamily) && randomFamily.length > 10
              "
              class="family-bottom"
...
export default {
  components: {
    ...
    photo: defineAsyncComponent(() => import('./common/photo')),
  ...
  methods: {
    ...
    submitLove() {
      ...
      this.$http
        .post(this.$constant.baseURL + '/family/saveFamily', this.userLove)
        .then((res) => {
          this.$message({
            type: 'success',
            message: '提交成功，待管理员审核！',
    ...
    addFamily() {
      ...
      this.$http
        .get(this.$constant.baseURL + '/family/getFamily')
        .then((res) => {
    ...
    getPhotoTitles() {
      this.$http
        .get(this.$constant.baseURL + '/webInfo/listAdminLovePhoto')
        .then((res) => {
          if (!this.$common.isEmpty(res.data)) {
