<template>
  <div class="tree-hole-container centered-dialog">
            ...
            <div style="display: flex; justify-content: space-between">
              ...
              <div
                ...
                v-if="
                  ...
                  mainStore.currentUser.id === treeHole.userId
                "
              >
                <svg
...
.tree-hole-box > div:last-child {
  color: #666666; /* 固定深灰色，因为背景是彩色的 */
  padding: 10px 10px 0;
  border-top: 1px dashed rgba(0, 0, 0, 0.2); /* 固定深色虚线 */
  font-size: 14px;
}
.tree-hole-delete {
  font-size: 14px;
